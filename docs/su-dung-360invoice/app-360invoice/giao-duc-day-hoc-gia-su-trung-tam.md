...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (125).png" alt="" width="236" /><figcaption></figcaption></figure>
</div>

2. Nhấn vào biểu tượng dấu (+) ở góc phải màn hình và Chọn Thêm nhóm hàng.

<div style={{display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap'}}>
  <figure><img src="/img/assets/image (127).png" alt="" width="234" /><figcaption></figcaption></figure>
  <figure><img src="/img/assets/image (128).png" alt="" width="235" /><figcaption></figcaption></figure>
</div>

3. Nhận tên môn học vào ô Tên nhóm hàng (Ví dụ: "Vật lý", "Toán", "Tiếng Anh") và nhấn nút Tạo nhóm sản phẩm để hoàn tất.

<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (129).png" alt="" width="234" /><figcaption></figcaption></figure>
</div>
...
<div style={{display: 'flex', justifyContent: 'center', gap: '16px', flexWrap: 'wrap'}}>
  <figure><img src="/img/assets/image (130).png" alt="" width="237" /><figcaption></figcaption></figure>
  <figure><img src="/img/assets/image (131).png" alt="" width="234" /><figcaption></figcaption></figure>
</div>

2. Điền các thông tin của lớp học:

- Tên sản phẩm: Nên ghi rõ Tên lớp - Môn học - Tên giáo viên để dễ phân biệt (Ví dụ: "L8 - Vật lý - Cô Hà").
- Đơn vị tính: Nhập thời gian thu học phí (Ví dụ: "Tháng" hoặc "Khóa").
- Giá bán lẻ: Nhập mức học phí của lớp học đó (Ví dụ: "500.000").

<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (132).png" alt="" width="238" /><figcaption></figcaption></figure>
</div>

- Nhóm hàng: Nhấn vào mục Chọn nhóm hàng và chọn môn học tương ứng đã tạo Bước (Ví dụ: Vật lý).

<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (133).png" alt="" width="240" /><figcaption></figcaption></figure>
</div>
...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (135).png" alt="" width="240" /><figcaption></figcaption></figure>
</div>
...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (136).png" alt="" width="233" /><figcaption></figcaption></figure>
</div>
...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (137).png" alt="" width="232" /><figcaption></figcaption></figure>
</div>
...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (138).png" alt="" width="229" /><figcaption></figcaption></figure>
</div>
...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (139).png" alt="" width="229" /><figcaption></figcaption></figure>
</div>
...
<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (140).png" alt="" width="231" /><figcaption></figcaption></figure>
</div>

4. Màn hình sẽ hiển thị Hóa đơn bán hàng. Nhấn nút In hóa đơn ở góc phải dưới để in biên lai cho học viên.

<div style={{display: 'flex', justifyContent: 'center'}}>
  <figure><img src="/img/assets/image (141).png" alt="" width="229" /><figcaption></figcaption></figure>
</div>
